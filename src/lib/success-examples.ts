...
export const GLOBAL_BEST_PRACTICES: SuccessfulExample[] = [
  {
    ...
    final_script: JSON.stringify({
      ...
      visual_cues: [
        ...
        "12-15s: Final organized result, creator smiling and pointing to link"
      ],
      voiceover: [
        ...
        "CTA (12-15s): 'My workspace is finally organized. Link in bio if you want the same!'"
      ],
      text_overlay: [
        "0-3s: 'DESK CHAOS 😫'",
        "5-10s: 'Lost 2 hours a day searching'",
        "15-20s: 'This changed everything ✨'",
        "13-15s: 'Finally organized! 🔗'"
      ]
    }),
  ...
  },
  {
    ...
    final_script: JSON.stringify({
      ...
      visual_cues: [
        ...
        "12-15s: Final gleaming result with product visible"
      ],
      voiceover: [
        ...
        "CTA (12-15s): 'Transform yours today. 50% off with code RESTORE50!'"
      ],
      text_overlay: [
  ...
  },
  {
    ...
    final_script: JSON.stringify({
      ...
      visual_cues: [
        ...
        "12-15s: Final result with product packaging visible"
      ],
      voiceover: [
        ...
        "CTA (12-15s): 'Ready for your transformation? Link in bio. 30-day guarantee!'"
      ],
      text_overlay: [
        ...
        "13-15s: 'Your turn! 🔗 30-day guarantee'"
      ]
    }),
